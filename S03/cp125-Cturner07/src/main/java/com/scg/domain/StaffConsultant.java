...
public final class StaffConsultant extends Consultant implements Serializable {
     ...
     */
    public synchronized void setPayRate(final int payRate) throws PropertyVetoException {
     ...
     * @param l the listener
     */
    public synchronized void addPayRateListener(final PropertyChangeListener l) {
     ...
     * @param l the listener
     */
    public synchronized void removePayRateListener(final PropertyChangeListener l) {
     ...
     * @param l the listener
     */
    public synchronized void addVetoableChangeListener(final VetoableChangeListener l) {
     ...
     * @param l the listener
     */
    public synchronized void removeVetoableChangeListener(final VetoableChangeListener l) {
     ...
     */
    public synchronized void setSickLeaveHours(final int sickLeaveHours) {
     ...
     * @param l the listener
     */
    public synchronized void addSickLeaveHoursListener(final PropertyChangeListener l) {
     ...
     * @param l the listener
     */
    public synchronized void removeSickLeaveHoursListener(final PropertyChangeListener l) {
     ...
     */
    public synchronized void setVacationHours(final int vacationHours) {
     ...
     * @param l the listener
     */
    public synchronized void addVacationHoursListener(final PropertyChangeListener l) {
     ...
     * @param l the listener
     */
    public synchronized void removeVacationHoursListener(final PropertyChangeListener l) {
